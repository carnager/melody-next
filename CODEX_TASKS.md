...
1. **Listening history, resume, album shuffle:** local playback now collects
   ...
   search results and the stashed queue. ADR-0214 adds continuous album playback
   in both authorities; ADR-0215 adds explicit track/album history library queries.
   History sorting, current-tab history scope, and calendar-relative operators
   remain open.

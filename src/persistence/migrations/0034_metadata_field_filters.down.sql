...
WHERE (chain_id, action_position) IN
      (SELECT chain_id, position FROM metadata_transformation_actions WHERE kind IN (18, 19));
DELETE FROM metadata_transformation_actions WHERE kind IN (18, 19);
ALTER TABLE metadata_transformation_action_values RENAME TO metadata_transformation_action_values_v34;
ALTER TABLE metadata_transformation_actions RENAME TO metadata_transformation_actions_v34;
...
INSERT INTO metadata_transformation_actions SELECT * FROM metadata_transformation_actions_v34;
INSERT INTO metadata_transformation_action_values SELECT * FROM metadata_transformation_action_values_v34;
DROP TABLE metadata_transformation_action_values_v34;
DROP TABLE metadata_transformation_actions_v34;
